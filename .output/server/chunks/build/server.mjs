...
const _routes = [
  {
    ...
    component: () => import('./book-detail.vue.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "my-library",
    path: "/my-library",
    component: () => import('./my-library.vue.mjs')
  },
  {
    name: "register",
    path: "/register",
  ...
  actions: {
    async login(username, password) {
      ...
      try {
        ...
        this.error = ((_a = err == null ? void 0 : err.data) == null ? void 0 : _a.message) || "Error al iniciar sesión";
        throw err;
      } finally {
        this.loading = false;
      }
    },
    async register(name, lastname, email, username, password) {
      var _a;
      this.loading = true;
      this.error = null;
      try {
        ...
        this.error = ((_a = err == null ? void 0 : err.data) == null ? void 0 : _a.message) || "Error al registrarse";
        throw err;
      } finally {
        this.loading = false;
      }
    ...
    async initAuth() {
      ...
      try {
        const config = useRuntimeConfig();
        const profile = await $fetch(`${config.public.apiBase}/auth/profile`, {
          headers: {
...
const api_jy9dy79pM_nYQuRKPrcfNg56p_gKkzw9SekUTZgAenc = defineNuxtPlugin((nuxtApp) => {
  return {
    provide: {
      api: useApi()
    }
...
export { useApi as a, useRouter as b, useNuxtApp as c, defineNuxtRouteMiddleware as d, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useAuthStore as u };
